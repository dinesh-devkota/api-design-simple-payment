package com.customercare.handler;
 ...
 * Controllers remain free of error-handling boilerplate.
 *
 * <p>{@link ErrorResponse} is generated from {@code openapi.yaml}.
 */
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> buildResponse(HttpStatus status,
                                                         String message,
                                                         List<String> errors) {
        // Generated model uses fluent setters (no Lombok @Builder)
